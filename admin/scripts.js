jQuery(document).ready(function() {
	try {
        ...
        jQuery('input#form-name:enabled').css({
            cursor: 'pointer'
        });

        jQuery('input#form-name').mouseover(function() {
            jQuery(this).not('.focus').css({
                'background-color': '#ffffdd'
            });
        });

        jQuery('input#form-name').mouseout(function() {
            jQuery(this).css({
                'background-color': '#fff'
            });
        });

        jQuery('input#form-name').focus(function() {
        ...
        jQuery('input#form-name').blur(function() {
...
function tagGenerator() {
  ...
  var dropdown_icon = jQuery('<img src="' + _suptic.pluginUrl + '/images/dropdown.gif" />');
  dropdown_icon.css({ 'vertical-align': 'bottom' });
  
  var selector = jQuery('<span>' + _supticL10n.generateTag + '</span>');
  ...
  var tag_types = [
    ...
    'acceptance', 'quiz', 'captcha', 'submit'];

  jQuery.each(tag_types, function(i, n) {
    var submenu = jQuery('<div>' + _supticL10n[n] + '</div>');
    submenu.css({
      margin: 0,
      padding: '0 4px',
      'line-height': '180%',
...
function tgPane(pane, tagType) {
  ...
  var paneTitle = jQuery('<div class="tg-panetitle">' + _supticL10n[tagType] + '</div>');
  ...
  jQuery.each([ 'isRequiredField', 'allowsMultipleSelections', 'insertFirstBlankOption',
	'makeCheckboxesExclusive', 'isAcceptanceDefaultOn', 'isAcceptanceInvert',
  ...
  switch (tagType) {
    ...
    case 'emailField':
      ...
      pane.append(table1);
      table1.append(tgTr(
        jQuery('<span>&nbsp;' + _supticL10n.isRequiredField + '</span>').prepend(tgInputs.isRequiredField)
      ));
      table1.append(tgTr(
        jQuery('<span>' + _supticL10n.tagName + '<br /></span>').append(tgInputs.tagName),
        jQuery('<span></span>')
      ));
      ...
      pane.append(table2);
      table2.append(tgTr(
        jQuery('<span><code>size</code> (' + _supticL10n.optional + ')<br /></span>').append(tgInputs.tagSize),
        jQuery('<span><code>maxlength</code> (' + _supticL10n.optional + ')<br /></span>').append(tgInputs.tagMaxLength)
      ));
      table2.append(tgTr(
        jQuery('<span><code>id</code> (' + _supticL10n.optional + ')<br /></span>').append(tgInputs.tagId),
        jQuery('<span><code>class</code> (' + _supticL10n.optional + ')<br /></span>').append(tgInputs.tagClasses)
      ));
      var akismetOpts = jQuery('<span>' + _supticL10n.akismet + ' (' + _supticL10n.optional + ')<br /></span>');
      if ('textField' == tagType) {
        akismetOpts.append(tgInputs.akismetAuthor).append('&nbsp;' + _supticL10n.akismetAuthor);
        akismetOpts.append('<br />');
        akismetOpts.append(tgInputs.akismetAuthorUrl).append('&nbsp;' + _supticL10n.akismetAuthorUrl);
      } else if ('emailField' == tagType) {
        akismetOpts.append(tgInputs.akismetAuthorEmail).append('&nbsp;' + _supticL10n.akismetAuthorEmail);
      }
      table2.append(tgTr(
        akismetOpts,
        jQuery('<span>' + _supticL10n.defaultValue + ' (' + _supticL10n.optional + ')<br /></span>').append(tgInputs.defaultValue)
      ));
      pane.append(jQuery('<div class="tg-tag">' + _supticL10n.generatedTag + '<br /></div>').append(tgInputs.tag1st));
      break;
    case 'textArea':
      var table1 = jQuery('<table></table>');
      pane.append(table1);
      ...
      pane.append(table2);
      table2.append(tgTr(
        jQuery('<span><code>cols</code> (' + _supticL10n.optional + ')<br /></span>').append(tgInputs.tagCols),
        jQuery('<span><code>rows</code> (' + _supticL10n.optional + ')<br /></span>').append(tgInputs.tagRows)
      ));
      table2.append(tgTr(
        jQuery('<span><code>id</code> (' + _supticL10n.optional + ')<br /></span>').append(tgInputs.tagId),
        jQuery('<span><code>class</code> (' + _supticL10n.optional + ')<br /></span>').append(tgInputs.tagClasses)
    ...
    case 'radioButtons':
      ...
      if ('menu' == tagType) {
        var menuOpt1 = jQuery('<span>&nbsp;' + _supticL10n.allowsMultipleSelections + '</span>').prepend(tgInputs.allowsMultipleSelections).prepend('<br />');
        var menuOpt2 = jQuery('<span>&nbsp;' + _supticL10n.insertFirstBlankOption + '</span>').prepend(tgInputs.insertFirstBlankOption).prepend('<br />');
        
        table2.append(tgTr(
          jQuery('<span>' + _supticL10n.menuChoices + '<br /></span>').append(tgInputs.menuChoices)
            .append('<br /><span style="font-size: smaller">' + _supticL10n.oneChoicePerLine + '</span>'),
        ...
        table2.append(tgTr(
          jQuery('<span>' + _supticL10n.menuChoices + '<br /></span>').append(tgInputs.menuChoices)
            .append('<br /><span style="font-size: smaller">' + _supticL10n.oneChoicePerLine + '</span>'),
          jQuery('<span>&nbsp;' + _supticL10n.makeCheckboxesExclusive + '</span>').prepend(tgInputs.makeCheckboxesExclusive).prepend('<br />')
        ));
      } else {
        table2.append(tgTr(
          jQuery('<span>' + _supticL10n.menuChoices + '<br /></span>').append(tgInputs.menuChoices)
    ...
    case 'acceptance':
      ...
      var menuOpt1 = jQuery('<span>&nbsp;' + _supticL10n.isAcceptanceDefaultOn + '</span>').prepend(tgInputs.isAcceptanceDefaultOn).prepend('<br />');
      var menuOpt2 = jQuery('<span>&nbsp;' + _supticL10n.isAcceptanceInvert + '</span>').prepend(tgInputs.isAcceptanceInvert).prepend('<br />');
      menuOpt2.append('<br /><span style="font-size: smaller;">' + _supticL10n.isAcceptanceInvertMeans + '</span>');
    ...
    case 'quiz':
      ...
      table2.append(tgTr(
        jQuery('<span>' + _supticL10n.quizzes + '<br /></span>').append(tgInputs.menuChoices)
          .append('<br /><span style="font-size: smaller">' + _supticL10n.quizFormatDesc + '</span>')
      ));
      pane.append(jQuery('<div class="tg-tag">' + _supticL10n.generatedTag + '<br /></div>').append(tgInputs.tag1st));
      break;
    case 'captcha':
      ...
      pane.append(table1);
        ...
        if (! _suptic.captchaMod) {
            table1.append('<tr><td colspan="2"><strong style="color: #e6255b">' +
                _supticL10n.needReallySimpleCaptcha + '</strong><br />' +
      ...
      var table2 = jQuery('<table></table>');
      pane.append(table2);
      table2.append('<caption>' + _supticL10n.imageSettings + '</caption>');
      var imageSizeOpts = jQuery('<span>' + _supticL10n.imageSize + ' (' + _supticL10n.optional + ')<br /></span>');
      imageSizeOpts.append(tgInputs.imageSizeSmall).append('&nbsp;' + _supticL10n.imageSizeSmall);
      imageSizeOpts.append('&emsp;');
      imageSizeOpts.append(tgInputs.imageSizeMedium).append('&nbsp;' + _supticL10n.imageSizeMedium);
      imageSizeOpts.append('&emsp;');
      imageSizeOpts.append(tgInputs.imageSizeLarge).append('&nbsp;' + _supticL10n.imageSizeLarge);
      table2.append(jQuery('<tr></tr>').append(jQuery('<td colspan="2"></td>').append(imageSizeOpts)));
      table2.append(tgTr(
        jQuery('<span>' + _supticL10n.fgColor + ' (' + _supticL10n.optional + ')<br /></span>').append(tgInputs.fgColor),
        jQuery('<span>' + _supticL10n.bgColor + ' (' + _supticL10n.optional + ')<br /></span>').append(tgInputs.bgColor)
      ));
      table2.append(tgTr(
        jQuery('<span><code>id</code> (' + _supticL10n.optional + ')<br /></span>').append(tgInputs.tagId),
        jQuery('<span><code>class</code> (' + _supticL10n.optional + ')<br /></span>').append(tgInputs.tagClasses)
      ...
      pane.append(table3);
      table3.append('<caption>' + _supticL10n.inputFieldSettings + '</caption>');
      table3.append(tgTr(
        jQuery('<span><code>size</code> (' + _supticL10n.optional + ')<br /></span>').append(tgInputs.tagSize),
        jQuery('<span><code>maxlength</code> (' + _supticL10n.optional + ')<br /></span>').append(tgInputs.tagMaxLength)
      ));
      table3.append(tgTr(
        jQuery('<span><code>id</code> (' + _supticL10n.optional + ')<br /></span>').append(tgInputs.tagId2),
        jQuery('<span><code>class</code> (' + _supticL10n.optional + ')<br /></span>').append(tgInputs.tagClasses2)
      ));
      pane.append(
        jQuery('<div class="tg-tag">' + _supticL10n.generatedTag + '</div>')
          .append('<br />').append('1) ' + _supticL10n.tagForImage)
          .append(tgInputs.tag1st)
          .append('<br />').append('2) ' + _supticL10n.tagForInputField)
    ...
    case 'submit':
      ...
      table.append(tgTr(
        jQuery('<span>' + _supticL10n.label + '<br /></span>').append(tgInputs.label),
        jQuery('<span></span>')
      ));
      pane.append(jQuery('<div class="tg-tag">' + _supticL10n.generatedTag + '<br /></div>').append(tgInputs.tag1st));
      break;
